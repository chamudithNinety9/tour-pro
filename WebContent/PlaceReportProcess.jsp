...
<%@page import="place.DatabaseConnecter"%>
...
<head>
	...
	<title>Place Register Report Preview</title>
...
<hr>
<br>
<p><tab1><b><u><font size="+2" color="886C65">Place or Destination REPORT</b></u></font></tab1></p>
...
String strQuery = "SELECT COUNT(*) FROM place1";
ResultSet rs = st.executeQuery(strQuery);
String Countrow="";
while(rs.next()){
Countrow = rs.getString(1);
out.println("Place  :" +Countrow);
}
}
catch (Exception e){
e.printStackTrace();
