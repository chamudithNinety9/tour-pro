  ...
  <img class="img" src="img\logo1.jpg" style="width:160px; top: 40px; margin:20px">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="CustomerView.jsp" class="active">
            <i class='bx bx-box' ></i>
...
%>
				  ...
				  <td><%=resultSet.getString("NoD") %></td>
				   ...
				   <td><a href="Update.jsp?Cid=<%=resultSet.getInt("Cid") %>"><button class="button1" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="fas fa-trash-alt"></span></button></p></a></td>
				 
				  <td><a href="Delete.jsp?Cid=<%=resultSet.getInt("Cid") %>"><button class="button1" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fas fa-trash-alt"></span></button></p></a></td>
