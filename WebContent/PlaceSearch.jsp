  ...
  <img class="img" src="img\logo1.jpg" style="width:160px; top: 40px; margin:20px">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="PlaceSearch.jsp" class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
       ...
       <left><form class="form-inline" action="PlaceSearch.jsp">
							  <input class="form-control mr-sm-2" type="search" placeholder=" Place ID...." aria-label="Search" name="search">
...
String sql ="select * from place1 where PLid="+search+" ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>
									
				  						<td bgcolor="#FFFFF0"><%=resultSet.getInt("PLid") %></td>
