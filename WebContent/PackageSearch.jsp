  ...
  <img class="img" src="img\logo1.jpg" style="width:160px; top: 40px; margin:20px">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="PackageSearch.jsp" class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
       ...
       <left><form class="form-inline" action="PackageSearch.jsp">
							  <input class="form-control mr-sm-2" type="search" placeholder=" Package ID...." aria-label="Search" name="search">
...
String sql ="select * from pack1 where Pid="+search+" ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>
									
				  						<td bgcolor="#FFFFF0"><%=resultSet.getInt("Pid") %></td>
