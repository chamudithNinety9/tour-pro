  ...
  <img class="img" src="img\logo1.jpg" style="width:160px; top: 40px; margin:20px">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="CustomerSearch.jsp"  class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
       ...
       <left><form class="form-inline" action="CustomerSearch.jsp">
							  <input class="form-control mr-sm-2" type="search" placeholder="Customer ID...." aria-label="Search" name="search">
...
String sql ="select * from customer1 where Cid="+search+" ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>
									
				  						<td bgcolor="#FFFFF0"><%=resultSet.getInt("Cid") %></td>
